...
android {
    ...
    signingConfigs {
        // Debug signing configuration: uses the standard Android debug keystore available in all environments
        // This keystore is auto-generated by Android toolchain and is suitable for CI/CD and local development
        getByName("debug") {
        ...
        // - STORE_PASSWORD: password for the release keystore
    ...
    buildTypes {
        ...
        debug {
            ...
            // Use standard debug keystore for all debug builds (all flavors)
            // This ensures consistent signing across CI/CD and local development environments
